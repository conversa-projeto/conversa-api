...
procedure TMensagemEventoTipo.Obter(var jaSaida: TJSONArray);
var
  consulta: TConsulta;
  sTexto: String;
begin
...
function TMensagemEventoTipo.Alterar: TJSONObject;
var
  I: Integer;
begin
  QryDados.Close;
...
function TMensagemEventoTipo.Excluir: TJSONObject;
begin
  QryDados.Close;
  QryDados.Open(
    'select * '+
